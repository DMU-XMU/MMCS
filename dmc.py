...
def make(name, frame_stack, action_repeat, seed, distracting_mode: str = None, multitask_mode: str = None):
    ...
    if (domain, task) in suite.ALL_TASKS:
        ...
        if distracting_mode is not None:
            ...
            kwargs['background_dataset_path'] = "/home/dmu00/ZYR/agent_mask/DAVIS/TEST2/480p"
            # kwargs['background_dataset_path'] = "/home/dmu00/ZYR/agent_mask/DAVIS/JPEGImages/480p" # DAVIS/JPEGImages/480p/
